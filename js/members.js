...
const HEROES = [
  ...
  { id: 'kayo_uc',     name: 'Kayo, Underhanded Cheat',          img: 'icon_kayo_uc-2.webp',       class: 'Brute' },
  { id: 'levia',       name: 'Levia, Shadowborn Abomination',    img: 'icon_levia.webp',            class: 'Brute' },
  { id: 'rhinar',      name: 'Rhinar, Reckless Rampage',         img: 'icon_rhinar_rr-1.webp',     class: 'Brute' },
  { id: 'tuffnut',     name: 'Tuffnut, Bumbling Hulkster',       img: 'icon_tuffnut-1.webp',       class: 'Brute' },
  // Guardian
  { id: 'betsy',       name: 'Betsy, Skin in the Game',          img: 'icon_betsy.webp',            class: 'Guardian' },
  ...
  { id: 'jarl',        name: 'Jarl Vetreiði',                    img: 'icon_jarl.webp',             class: 'Guardian' },
  { id: 'lyath',       name: 'Lyath Goldmane, Vile Savant',      img: 'icon_lyath-2.webp',         class: 'Guardian' },
  { id: 'oldhim',      name: 'Oldhim',                           img: 'icon_oldhim-1.webp',        class: 'Guardian' },
  { id: 'pleiades',    name: 'Pleiades, Superstar',              img: 'icon_pleiades-1.webp',      class: 'Guardian' },
  { id: 'terra',       name: 'Terra',                            img: 'icon_terra.webp',            class: 'Guardian' },
  { id: 'valda',       name: 'Valda, Seismic Impact',            img: 'icon_valda.webp',            class: 'Guardian' },
  { id: 'victor',      name: 'Victor Goldmane, High and Mighty', img: 'icon_victor.webp',           class: 'Guardian' },
  ...
  { id: 'gravybones',  name: 'Gravy Bones, Shipwrecked Looter',  img: 'icon_gravybones.webp',       class: 'Illusionist' },
  ...
  { id: 'zyggy',       name: 'Zyggy Starlight',                  img: 'icon_zyggy-1.webp',         class: 'Illusionist' },
  // Marchand
  ...
  { id: 'dash_io',     name: 'Dash I/O',                         img: 'icon_dash_io.webp',          class: 'Mechanologist' },
  { id: 'datadoll',    name: 'Data Doll',                        img: 'icon_datadoll.webp',         class: 'Mechanologist' },
  { id: 'maxxnitro',   name: "Maxx 'The Hype' Nitro",            img: 'icon_maxxnitro.webp',        class: 'Mechanologist' },
  { id: 'puffin',      name: 'Puffin, Hightail',                 img: 'icon_puffin.webp',           class: 'Mechanologist' },
  ...
  { id: 'ira',         name: 'Ira, Scarlet Revenger',            img: 'icon_ira.webp',              class: 'Ninja' },
  { id: 'katsu',       name: 'Katsu, the Wanderer',              img: 'icon_katsu.webp',            class: 'Ninja' },
  ...
  { id: 'marlynn',     name: 'Marlynn, Treasure Hunter',         img: 'icon_marlynn.webp',          class: 'Ranger' },
  { id: 'riptide',     name: 'Riptide, Lurker of the Deep',      img: 'icon_riptide.webp',          class: 'Ranger' },
  // Runeblade
  ...
  { id: 'vynnset',     name: 'Vynnset, Iron Maiden',             img: 'icon_vynnset.webp',          class: 'Runeblade' },
  // Warrior
  { id: 'boltyn',      name: 'Ser Boltyn, Breaker of Dawn',      img: 'icon_boltyn.webp',           class: 'Warrior' },
  { id: 'cindra',      name: 'Cindra, Dracai of Retribution',    img: 'icon_cindra.webp',           class: 'Ninja' },
  { id: 'dorinthea',   name: 'Dorinthea Ironsong',               img: 'icon_dorinthea.webp',        class: 'Warrior' },
  { id: 'fang',        name: 'Fang, Dracai of Blades',           img: 'icon_fang.webp',             class: 'Warrior' },
  { id: 'hala',        name: 'Hala, Bladesaint of the Vow',      img: 'icon_hala_pos.webp',         class: 'Warrior' },
  { id: 'kassai_cs',   name: 'Kassai, Cintari Sellsword',        img: 'icon_kassai_cs.webp',       class: 'Warrior' },
  { id: 'kassai_gs',   name: 'Kassai of the Golden Sand',        img: 'icon_kassai_gs.webp',       class: 'Warrior' },
  { id: 'olympia',     name: 'Olympia, Prized Fighter',          img: 'icon_olympia.webp',          class: 'Warrior' },
  // Wizard
  ...
  { id: 'oscilio',     name: 'Oscilio, Constella Intelligence',  img: 'icon_oscillio.webp',         class: 'Wizard' },
